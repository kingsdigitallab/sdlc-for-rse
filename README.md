...
```mermaid 
graph TB
Pre["<b>Pre-project stage</b><br/><small><b>Products: </b> Terms of reference (In)<br/><b>Goals: </b>Understand business case<br/><b>Roles: </b>Analyst, Project Manager, Director</small>"] --Go?--> 
...
{% include js/js.md %}
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTcyODI4MDUsLTEyMTcyNTU1OTksLTE2NT
Q3NzEwNTNdfQ==
-->